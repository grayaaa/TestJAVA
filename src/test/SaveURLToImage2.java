...
public class SaveURLToImage2 extends JPanel {
    /**
     *
     */
    ...
    public SaveURLToImage2(final String url, final int maxWidth, final int maxHeight) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.getContentPane().add(
                        new SaveURLToImage2("http://buzz100x.hz.youdao.com:30077/report/report.do?id=89dfc571533449a2b9c03b6046439216", 640, 480),
                        BorderLayout.CENTER);
