...
import parsexml.entity.Student;
...
public class PullParseXml {
	...
	public List<Student> PullParseXML() {
		...
		try {
			...
			// 设置输入流 xml文件
			xmlPullParser
					.setInput(Thread.currentThread().getContextClassLoader()
							.getResourceAsStream("parsexml/Student.xml"), "UTF-8");
	...
	public static void main(String[] args) {
		...
		for (Student student : list) {
			System.out.println("id:" + student.getId() + "\tgroup:" + student.getGroup() + "\tname:"
					+ student.getName() + "\tsex:" + student.getSex() + "\tage:" + student.getAge() + "\temail:"
					+ student.getEmail() + "\tbirthday:" + student.getBirthday() + "\tmemo:" + student.getMemo());
		}
	}
