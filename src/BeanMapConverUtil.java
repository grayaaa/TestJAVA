...
public class BeanMapConverUtil {
	...
	public static <T> void setProperties(T entity, String propertyName, Object value) throws IntrospectionException, IllegalArgumentException,
	...
	public static void main(String[] args) {
		...
		user.setName("刘少奇");
		user.setSex("boy");
		Map<String, Object> um = BeanMapConverUtil.beanToMap(user);
		;
		for (Map.Entry<String, Object> entity : um.entrySet()) {
			System.out.println(entity.getKey() + "," + entity.getValue());
		}

		User newUser = BeanMapConverUtil.mapToBean(um, User.class);
