...
public class JodaTest {
  ...
  public static void main(String[] args) {
    ...
    DateTime today = new DateTime(today_);
    System.out.println(today.toString("MM/dd/yyyy hh:mm:ss.SSSa"));

    System.out.println("dataTime2-->" + DateTime.parse("2012-12-03").toString("dd-MM-yyyy HH:mm:ss"));
