...
public class GSONUtil {
	...
	/** 默认的JSON日期/时间字段的格式化模式。 */
	public static final String DEFAULT_DATE_PATTERN = "yyyy-MM-dd HH:mm:ss SSS";

	/** Gson 的@Since注解常用的版本号常量 - {@code 1.0}。 */
	public static final double SINCE_VERSION_10 = 1.0d;

	/** Gson 的@Since注解常用的版本号常量 - {@code 1.1}。 */
	public static final double SINCE_VERSION_11 = 1.1d;

	/** Gson 的@Since注解常用的版本号常量 - {@code 1.2}。 */
	public static final double SINCE_VERSION_12 = 1.2d;

	/** Gson 的 <code>@Until</code> 注解常用的版本号常量 - {@code 1.0}。 */
	public static final double UNTIL_VERSION_10 = SINCE_VERSION_10;

	/** Gson 的 <code>@Until</code> 注解常用的版本号常量 - {@code 1.1}。 */
	public static final double UNTIL_VERSION_11 = SINCE_VERSION_11;

	/** Gson 的 <code>@Until</code> 注解常用的版本号常量 - {@code 1.2}。 */
	...
	/**
	 * 将给定的目标对象根据{@code GsonBuilder} 所指定的条件参数转换成JSON格式的字符串。
	 * <p />
	...
	/**
	 * 将给定的目标对象根据指定的条件参数转换成JSON格式的字符串。
	 * <p />
	...
	/**
	 * 将给定的目标对象转换成JSON格式的字符串。<strong>此方法只用来转换普通的 {@code JavaBean} 对象。</strong>
	 * <ul>
	...
	/**
	 * 将给定的目标对象转换成JSON格式的字符串。<strong>此方法通常用来转换使用泛型的对象。</strong>
	 * <ul>
	 * <li>该方法只会转换标有 {@literal @Expose} 注解的字段；</li>
	 * <li>该方法不会转换 {@code null} 值字段；</li>
	 * <li>该方法会转换所有未标注或已标注 {@literal @Since} 的字段；</li>
	...
	// 将给定的Map对象转换成指定的类型对象。参数同上
	public static <T> T fromJson(Map map, TypeToken<T> token, String datePattern) {
		GsonBuilder builder = new GsonBuilder();
		if (StringUtils.isBlank(datePattern)) {
			datePattern = DEFAULT_DATE_PATTERN;
		}
	...
	// 将给定的Map对象转换成指定的类型对象。参数同上
	public static <T> T fromJson(Map map, TypeToken<T> token) {
		return (T) fromJson(map, token, null);
	}

	/**
	 * 将给定的JSON字符串转换成指定的类型对象。<strong>此方法通常用来转换普通的 {@code JavaBean} 对象。</strong>
	 * 
	 * @param <T>
	 *            要转换的目标类型。
	 * @param json
	...
	// 将给定的Map对象转换成指定的类型对象。参数同上
	public static <T> T fromJson(Map map, Class<T> clazz, String datePattern) {
		GsonBuilder builder = new GsonBuilder();
		if (StringUtils.isBlank(datePattern)) {
			datePattern = DEFAULT_DATE_PATTERN;
		}
	...
	public static <T> T fromJson(Map map, Class<T> clazz) {
		return (T) fromJson(map, clazz, null);
	}
